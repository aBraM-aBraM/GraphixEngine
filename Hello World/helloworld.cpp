...
int main()
{
    ...
    unsigned int diffuseMap = loadTexture("C:\\Users\\User\\Desktop\\container2.png");
    unsigned int specularMap = loadTexture("C:\\Users\\User\\Desktop\\container2_specular.png");
    ...
    for (int i = 0; i < 4; i++)
    {
        glm::vec3 color = glm::vec3(0.3f * i, 0.5f * i, 0.9f * i);
        myShader.setLight(PointLight("pointLights[" + std::to_string(i) + "]", pointLightPositions[i], 0.2f * pointLightColors[i], 0.5f * pointLightColors[i], glm::vec3(1.0f), 1.0, 0.09f, 0.032f));
    }
